...
## System Overview
The Circles system consists of actors ([users](#users), [organizations](#organizations), and [validators](#validators)), [accounts](#account) (personal and organisational), [personal currencies](#personal-currencies), and a [social graph](#social-graph), faciliated through a blockchain-linked application. 
